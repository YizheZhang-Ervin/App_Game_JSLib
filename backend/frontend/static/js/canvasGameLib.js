...
function bgAppear() {
    ...
    let bgURL = "static/canvasGame/backgroundSea.png";
    image.src = bgURL;
...
function heroAppear() {
    ...
    let img = "static/canvasGame/hero.png";
...
function bulletAppear(hero, enemyArray) {
    ...
    let bURL = "static/canvasGame/bullet.png";
...
function enemyAppear(hero,speed) {
    ...
    setInterval(() => {
        ...
        let enemy;
        let eURL = "static/canvasGame/enemy.png";
        switch (number) {
            case 1: {
