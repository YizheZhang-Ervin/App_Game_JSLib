    ...
    <el-row type="flex" justify="space-around" class="space-v">
        ...
        <el-col :span="15">
            ...
            <div class="between">
                ...
                <el-image style="width: 70px; height: 80px" :src="logo" fit="contain">
                </el-image>
            </div>
            <!-- 专业领域 -->
            <div>
...
export default {
    ...
    data: function () {
        return {
            listShow: true,
            detailShow: false,
            logo:require("../assets/img/im.png"),
            memberDetail: {},
            members: [{
                index: '1',
                name: "张以哲",
                ...
                location: "广州",
                pro: "SAP",
                img: require("../assets/img/colin.jpg"),
                mail: "sxk@sxk.com",
                phone: "保密",
                contact: "保密",
                ...
                location: "无锡",
                pro: "销售",
                img: require("../assets/img/lqj.jpg"),
                mail: "lqj@lqj.com",
                phone: "保密",
                contact: "保密",
                linkedin: "#",
                ...
                location: "南通",
                pro: "未知",
                img: require("../assets/img/clj.jpg"),
                mail: "clj@clj.com",
                phone: "保密",
                contact: "保密",
                linkedin: "#",
